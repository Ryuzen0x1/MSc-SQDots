...
\begin{align}
    \Omega_p &=|\Omega_p|e^{-i\phi_p}=\frac{\mu_{21}\hat{e}_p E_p}{\hbar}e^{-i\phi_p},\\
    \Omega_c &=|\Omega_c|e^{-i\phi_c}=\frac{\mu_{32}\hat{e}_c E_c}{\hbar}e^{-i\phi_c},\\
    \Omega_b &=|\Omega_b|e^{-i\phi_b}=\frac{\mu_{43}\hat{e}_b E_b}{\hbar}e^{-i\phi_b},\\
    \Omega_d &=|\Omega_d|e^{-i\phi_d}=\frac{\mu_{42}\hat{e}_d E_d}{\hbar}e^{-i\phi_d},
\end{align}
...
\begin{align}
    \rho_{21} &= \tilde\rho_{21}e^{i\phi_p}e^{-i(k_p z-\omega_p t)},\\
    \rho_{31} &= \tilde\rho_{31}e^{-i(\phi_p+\phi_c)}e^{i(k_p z-\omega_p t)}e^{-i(k_c z-\omega_c t)},\\
    \rho_{41} &= \tilde\rho_{41}e^{-i(\phi_p+\phi_d)}e^{-i(k_p z-\omega_p t)}e^{-i(k_d z-\omega_d t)},\\
    \rho_{32} &= \tilde\rho_{32}e^{-i\phi_c}e^{-i(k_c z-\omega_c t)},\\
    \rho_{43} &= \tilde\rho_{43}e^{-i\phi_b}e^{-i(k_b z-\omega_b t)},
\end{align}.
