...
lgd = legend('show');
set(lgd, 'FontName', 'Garamond', 'FontSize', 20, 'FontWeight', 'bold', 'EdgeColor', ...
    'w', 'NumColumns', 3, 'Location', 'north', TextColor=[0 0 0]);
legend boxon;
...
file = fullfile(folder_path, 'Real_chi1_Omega_c.jpeg');
fig = gcf;
